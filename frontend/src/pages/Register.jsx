...
const Register = () => {
     ...
     return (
          <section className='h-screen w-full relative bg-white'>
               ...
               <div className='hidden md:flex flex-1/2 h-full bg-white p-3'>
                         <img src="https://thalasiknitfab.com/cdn/shop/files/WhatsApp_Image_2024-08-25_at_1.03.06_PM_1_349x.progressive.jpg?v=1724571403" alt="" className='w-full h-full object-cover' />
                    </div>
                    <div className='flex-1/2 h-full bg-white flex items-center justify-center'>
                         <div className='w-full h-full p-6 py-8 flex flex-col items-center justify-center'>
                              <h1 className='text-center uppercase font-bold text-3xl tracking-widest mb-10'>Sign up</h1>
                              <div className='w-full md:max-w-lg flex flex-col items-center justify-center gap-2'>
                                   <div className='w-full flex flex-col gap-2'>
                                        <label htmlFor="userName" className='font-bold text-lg tracking-wide'>Username</label>
                                        <input onChange={handleChange} type="text" name="userName" id="userName" className='w-full px-3 py-2 border-2 rounded-xl' placeholder='Enter username' required value={formData.userName} />
                                   </div>
                                   <div className='w-full flex flex-col gap-2'>
